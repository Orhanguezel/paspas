...
$(function() {
  ...
  $("#untree_co--overlayer").delay(700).fadeOut("slow");	
	...
	var menuToggle = function() {
		$('.js-windowmenu-toggle').on('click', function(e) {
			e.preventDefault();
			if ( $('#menu_menu').hasClass('active') ) {
  ...
  var owlCarouselPlugin = function() {
  	...
  	owlHeroSlider.owlCarousel({
        ...
        dots: true,
        nav: true,
        navText: ['<img src="assets/images/bnr-left.png" alt="" class="bnr-left">', '<img src="assets/images/bnr-right.png" alt="" class="bnr-right">'],
...
var small_product=$('.small_product').owlCarousel({
		  nav: false,
		  dots: false,
		  mouseDrag: true,
		  touchDrag: true,
...
$('.small-left').click(function(e){
	e.preventDefault();
	small_product.trigger('prev.owl.carousel');
});
$('.small-right').click(function(e) {
	e.preventDefault();
	small_product.trigger('next.owl.carousel');
});		


var hakkimizda=$('.about_us').owlCarousel({
		  nav: false,
		  dots: false,
		  mouseDrag: true,
		  touchDrag: true,
