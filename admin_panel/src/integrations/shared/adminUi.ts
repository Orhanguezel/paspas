...
export function normalizeAdminUiCopy(raw: unknown): AdminUiCopy {
  ...
  const items: AdminNavCopy["items"] = {
    ...
    fuar_genel_bakis: uiText(itemsRaw.fuar_genel_bakis),
    fuar_katalog: uiText(itemsRaw.fuar_katalog),
    fuar_urunler: uiText(itemsRaw.fuar_urunler),
    fuar_musteriler: uiText(itemsRaw.fuar_musteriler),
    fuar_teklifler: uiText(itemsRaw.fuar_teklifler),
    ...
    birimler: uiText(itemsRaw.birimler),
    vardiya_analizi: uiText(itemsRaw.vardiya_analizi),
