...
1. `main` uzerinde dogrudan calisma yapma
2. Yeni gorev icin branch ac
3. Degisiklikleri branch uzerinde yap
4. Gerekirse test/lint calistir
5. Commit at
6. Remote'a push et
7. CI/CD veya deploy akisini oradan ilerlet
...
- deploy ve runtime yonetimi ilgili sunucularda ayri olarak yapilir
...
- Koku tek bir teknik onboarding rehberine baglamak
- `.env.example` dosyalarini standartlastirmak
- Backend ve admin panel icin kurulum adimlarini daha ayrintili dokumante etmek
