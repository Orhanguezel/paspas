  ...
  const [items, countResult] = await Promise.all([
    db
      .select({
        ...
        website_url: musteriler.website_url,
        google_maps_url: musteriler.google_maps_url,
        instagram_url: musteriler.instagram_url,
        facebook_url: musteriler.facebook_url,
        bayi_segment: musteriler.bayi_segment,
        kredi_limit: musteriler.kredi_limit,
        mevcut_bakiye: musteriler.mevcut_bakiye,
        vade_gunu: musteriler.vade_gunu,
        portal_enabled: musteriler.portal_enabled,
        portal_status: musteriler.portal_status,
        public_veri_izni: musteriler.public_veri_izni,
