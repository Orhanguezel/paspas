...
export const teklifler = mysqlTable('teklifler', {
  ...
  goruntuleme_token_expires_at: datetime('goruntuleme_token_expires_at'),
  goruntuleme_token_revoked_at: datetime('goruntuleme_token_revoked_at'),
...
export function teklifRowToDto(
  ...
  return {
    ...
    goruntulemeTokenExpiresAt: row.goruntuleme_token_expires_at ?? null,
    goruntulemeTokenRevokedAt: row.goruntuleme_token_revoked_at ?? null,
