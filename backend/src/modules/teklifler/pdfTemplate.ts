...
export function renderTeklifHtml(input: TeklifPdfInput): string {
  ...
  const termsBlok = (t.odemeKosullari || t.teslimKosullari) ? `
    <div class="terms">
  ...
  const customerMessageBlok = t.aciklama ? `
    <div class="terms customer-message">
      <div class="eyebrow">${text.customerMessage}</div>
      <p>“${esc(t.aciklama)}”</p>
    </div>` : '';
...
<body><div class="sheet">
  ...
  <div class="lower">${payBlok}${termsBlok}${customerMessageBlok}</div>
